...
// change "2014170935" to your real student id
class Bingo_2014170935 : public Bingo { // This is simple strategy only think of me not other
public:
	// change "2014170935" to your real student id
	Bingo_2014170935() {
		mName = "Jikjoo"; // change "MyName" to your real name in English5
		mWeight = NULL;
		itsdiff = NULL;
		next_idx = 0;
		weight = 2;
...
void Bingo_2014170935::weightInitialize() {
...
void Bingo_2014170935::itsdiffInitialize() {
...
void Bingo_2014170935::weightAdd(int data) {
...
void Bingo_2014170935::weightShow() {
...
void Bingo_2014170935::weightSub(int data) {
	int idx = findIdxbyData(data);
	mWeight[idx] -= 1;
}

int Bingo_2014170935::findIdxbyData(int data) {
