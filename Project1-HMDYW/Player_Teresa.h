...
#ifndef _PLAYER_Teresa_H_
#define _PLAYER_Teresa_H_

#include "setting.h"
#include "Player.h"

// change "2017000000" to your real student id
class Player_Teresa: public Player
{
public:
	Player_Teresa() {
		mName = "Mother Teresa"; 	// change "MyName" to your real name
		// add whatever
	}
	~Player_Teresa() { 
		// add whatever
...
**********************************************************/
int Player_Teresa::offer(const string &itsname,int money,const History *myoffer,const History *itsoffer,int nmatch)
{
...
/********************************************************
  ...
  nmatch: number of game sets, i.e. the length of "myoffer" and "itsoffer" vectors
**********************************************************/
bool Player_Teresa::accept(const string &itsname,int money,const History *myoffer,const History *itsoffer,int nmatch)
{
	// implement your strategy
	return false;	
}
